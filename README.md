...
- **Synthetic dataset & evaluation** — ground-truth dataset generation, Chamfer/F-score/image-based metrics, and sweep tooling in [`scripts/`](scripts/).
...
The original RIFTCast README follows below.
